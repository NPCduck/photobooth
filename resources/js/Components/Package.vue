    ...
    <div class="relative grid grid-cols-4 gap-4 items-start packages mr-8">
        ...
        <div class="flex flex-col p-2 gap-2 border border-sidebarbg rounded-md">
            <div class="flex flex-col">
                ...
                <input type="text" :id="'packagePhotoLimitPerson-' + id" class="rounded-md border-0 bg-overlaybg">
            </div>
            <div class="flex flex-row items-center gap-2">
                <input type="checkbox" :id="'packageUnlimitedPhotosPerson-' + id" class="bg-overlaybg border-0 rounded-md">
